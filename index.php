        ...
        <section class="section order">
          <div class="container">
            ...
            <div class="order__form">
              <form class="order__form-tag" id="order-form" action = "login.php" method = "post">
                <div class="order__form-col">
                  ...
                  <div class="order__form-row order__form-row_double">
                    <label class="order__form-block">
                      ...
                      <input class="order__form-input" id = "email" name="email" type="email" placeholder="">
                    </label>
                    <label class="order__form-block">
                  ...
                  <div class="order__form-buttons">
                    <div class="order__form-row">
                      <label class="order__radio">
                        <input class="order__radio-elem" name="payment" type="radio" value ='nal'>
                    ...
                    <div class="order__form-row">
                      ...
                      <input class="order__form-button order__form-button_reset" name="reset" type="reset" value="Очистить">
                    </div>
                  </div>
                </div>
              </form>
